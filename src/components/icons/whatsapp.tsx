 ...
 * The WhatsApp mark.
 *
 * lucide-react carries no brand glyphs, so this is the real WhatsApp shape —
 * the handset inside a speech bubble with the bubble's tail on the lower left —
 * drawn as a single filled path.
 *
 ...
 * hollowing it out throws that away. The FAB keeps its own lighter outline
 * version, which is a different job — a large floating control that should sit
 * quietly rather than announce a brand.
 *
